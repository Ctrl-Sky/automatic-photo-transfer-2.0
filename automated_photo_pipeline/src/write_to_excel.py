...
def write_to_migration_table(device, start_and_end_values, table_path, migration_name=""):
    start_image = start_and_end_values[0]
    start_date = start_and_end_values[1]
    end_image = start_and_end_values[2]
    end_date = start_and_end_values[3]
    ...
    data = [today, migration_name, device, start_image, start_date, end_image, end_date, current_timezone]
